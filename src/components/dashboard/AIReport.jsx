...
import { Brain, Sparkles, AlertCircle, RefreshCw, Copy, Check, WifiOff } from "lucide-react";
      ...
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${isOfflineMode ? 'bg-amber-500/10' : 'bg-purple-500/10'}`}>
              {isOfflineMode ? (
            ...
            <div>
              ...
              <CardDescription>
                {isOfflineMode ? "Generated locally" : "Generated by Gemini AI"}
              </CardDescription>
            </div>
          </div>
          <div className="flex items-center gap-2">
          ...
          {loading && (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <p className="text-sm font-medium text-white">Analyzing your audit data...</p>
                  <TypingIndicator />
                </div>
              </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-amber-300">
                      Showing locally-generated report. Connect to the internet for AI-enhanced insights.
                    </p>
                    <Button 
                      variant="ghost" 
                      size="sm" 
